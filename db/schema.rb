...
ActiveRecord::Schema[7.0].define(version: 20_230_428_040_846) do
  ...
  create_table 'user_follow_tags', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['tag_id'], name: 'index_user_follow_tags_on_tag_id'
    t.index ['user_id'], name: 'index_user_follow_tags_on_user_id'
  end
